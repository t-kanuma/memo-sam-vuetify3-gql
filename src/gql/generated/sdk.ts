...
export function getSdk(
  ...
  return {
    getMemos(
      variables: GetMemosQueryVariables,
      requestHeaders?: GraphQLClientRequestHeaders
    ): Promise<GetMemosQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetMemosQuery>(GetMemosDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        "getMemos",
    ...
    createMemo(
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<CreateMemoMutation>(CreateMemoDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        "createMemo",
    ...
    updateMemo(
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<UpdateMemoMutation>(UpdateMemoDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        "updateMemo",
